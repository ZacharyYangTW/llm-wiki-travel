...
WIKI_BASE = r"h:\我的雲端硬碟\llm_wiki_travel\wiki\泰國"
...
for source_name, target_name in sorted(MERGE_MAP.items()):
    ...
    if not items:
        ...
        try:
            ...
            failed_list.append((source_name, str(e)[:50]))
        continue
    ...
    for item in items:
        ...
        try:
            ...
            failed_list.append((f"{source_name}/{item}", str(e)[:50]))
    ...
    try:
        ...
        failed_list.append((source_name, f"刪除失敗: {str(e)[:30]}"))
