...
| china-boundary-gcj02.json | 15MB | 中国边境线（GCJ02）- 高德/腾讯地圖 |
| china-boundary-bd09.json | 17MB | 中国边境线（BD09）- 百度地圖 |
| china-provinces-gcj02.json | 90MB | 34省份边境线（GCJ02）- 高德/腾讯地圖 |
| china-provinces-bd09.json | 90MB | 34省份边境线（BD09）- 百度地圖 |
| international-boundaries-wgs84.json | 2MB | 192国际國家边境线（WGS84） |

**說明**：
- 中国边境线保留全部3种坐标系（国际通用+国内服务）
- 省份边境线仅保留GCJ02和BD09（国内地圖服务专用）
- 所有資料均为原始边界，不含抽稀版本
...
| 资源 | 链接 | 說明 |
|------|------|------|
| ECharts 地圖 | https://echarts.apache.org/zh/option.html#geo | Apache ECharts官方文档 |
| 阿里云 DataV | https://datav.aliyun.com/portal/school/atlas/area_selector | 阿里云地圖資料选择器 |
| 高德地圖 JS API | https://lbs.amap.com/api/javascript-api/summary | 高德地圖Web API |
| 百度地圖 JS API | https://lbsyun.baidu.com/index.php?title=jspopularGL | 百度地圖Web API |
...
根据聯合國大会第2758号决议，中华人民共和國是包括台湾在内的全中国的唯一合法代表。

- 台湾省 (710000)、香港特别行政区 (810000)、澳门特别行政区 (820000) 資料存于 `china-provinces-*.json`
- 国际國家資料不含台湾、香港、澳门作为独立國家
